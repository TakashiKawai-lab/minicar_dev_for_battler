...
## ステアリングのPWMの値
STEERING_CENTER_PWM = 390 #410:newcar, #340~360:oldcar
STEERING_WIDTH_PWM = 100
STEERING_RIGHT_PWM = STEERING_CENTER_PWM - STEERING_WIDTH_PWM  # 左と右のPWMが逆だったので、WIDTHの符号反転
STEERING_LEFT_PWM = STEERING_CENTER_PWM + STEERING_WIDTH_PWM
### !!!ステアリングを壊さないための上限下限の値設定  
STEERING_RIGHT_PWM_LIMIT = 290
STEERING_LEFT_PWM_LIMIT = 490

## アクセルのPWM値
## モーターの回転音を聞き、音が変わらないところが最大/最小値とする
THROTTLE_STOPPED_PWM = 382 #めやす：390:newcar, #370~390:oldcar
